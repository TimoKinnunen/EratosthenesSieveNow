...
namespace EratosthenesSieveNow.Views
{
    public sealed partial class DatabaseInfoPage : Page
    {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            // code here
            #region EratosthenesSieveNow.db
            ...
            StorageFile fileEratosthenesSieveNow = await StorageFile.GetFileFromPathAsync(App.DatabasePath);
            if (fileEratosthenesSieveNow != null)
            {
                BasicProperties basicPropertiesEratosthenesSieveNow = await fileEratosthenesSieveNow.GetBasicPropertiesAsync();
                EratosthenesSieveNowFileSize.Text = $"File EratosthenesSieveNow.db's size is {HelpToFileSize.ToFileSize(basicPropertiesEratosthenesSieveNow.Size)}.";
                EratosthenesSieveNowFilePath.Text = @fileEratosthenesSieveNow.Path;
            }
            else
            {
                EratosthenesSieveNowFileSize.Text = "File EratosthenesSieveNow.db is missing.";
            }
            #endregion EratosthenesSieveNow.db
            // code here
        }
